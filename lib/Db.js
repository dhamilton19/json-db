...
var Db = function () {
	...
	_createClass(Db, null, [{
		...
		value: function read() {
			...
			try {
				this.entries = JSON.parse(_fs2.default.readFileSync(this.directory + this.fileName, 'utf-8'));
		...
		value: function write() {
			...
			return new Promise(function (resolve) {
				_fs2.default.writeFile(_this2.directory + _this2.fileName, JSON.stringify(_this2.entries), 'utf-8', function () {
					resolve();
				});
			});
		}
		...
		value: function getAll(callback) {
			callback(_defineProperty({}, fileName, this.entries));
		}
	}, {
